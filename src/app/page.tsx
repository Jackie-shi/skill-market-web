          ...
          {authStatus !== "loading" && !session && (
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-white/10 border border-white/20 px-6 py-3 text-sm font-medium text-white hover:bg-white/20 transition-colors backdrop-blur-sm"
              >
              ...
              <Tooltip content="Sign in to publish skills, track downloads, and earn money" position="bottom">
                <span className="text-xs text-gray-500 cursor-help underline decoration-dotted underline-offset-4">
                  Why sign in?
                </span>
              </Tooltip>
            </div>
